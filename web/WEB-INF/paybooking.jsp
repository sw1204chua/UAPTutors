<%-- 
    Document   : paybooking
    Created on : 11 27, 24, 8:45:43 AM
    Author     : 220129
--%>
            ...
            <div style = 'display: flex; flex-direction: column; justify-content: center; min-height: 85vh'>
                <c:choose>
                    <c:when test = '${error==false}'>
                        <h1 style = align-self:center>Listing Information:</h1>
                        <div class = form-container style = 'text-align:left'>
                            <form action = 'do.confirmpayment' method = 'post'>
                                <h2 style = text-align:left>Method of Payment:<br>${listing.getMop()}</h2>
                                <h2 style = text-align:left>Account Number:<br>${listing.getNumber()}</h2> 
                                <h2 style = text-align:left>Price:<br>${listing.getPrice()}</h2>
                                <input type = hidden name = booked_id value ="${listing.getBooked_id()}">
                                <h2 style = text-align:left>Reference Number:</h2>
