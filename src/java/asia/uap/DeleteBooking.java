 ...
 * @author Hawy
 */
@WebServlet(name = "DeleteBooking", urlPatterns = {"/profile/do.deletelisting"})
public class DeleteBooking extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String successmsg = "Listing Deleted!";
        String err = "Listing Could Not Be Deleted!";
        String href1 = "";
        String href1msg = "";
        ...
        if(!error){
            try{
                dbOp.deleteListing((listing.getId()));
