 ...
 * @author Hawy
 */
@WebServlet(name = "EditLanguage", urlPatterns = {"/profile/do.editlanguage"})
public class EditLanguage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        href1 = "do.languageslist";
        href1msg = "Back to Language List";
