 ...
 * @author Hawy
 */
@WebServlet(name = "LanguageList", urlPatterns = {"/profile/do.languageslist"})
public class LanguageList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!error) {
            userLanguages = user.getLanguages();  // Assuming getLanguages() retrieves the user's languages
        }
        ...
        String href1 = "";
        String href1msg = "";
        request.setAttribute("biolist", userLanguages);       
        href1 = "do.profile";
