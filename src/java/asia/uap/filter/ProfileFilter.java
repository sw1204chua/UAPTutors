...
public class ProfileFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        HttpSession session = req.getSession(); //gets current session
        HttpServletResponse resp = (HttpServletResponse) response; //typecasting

        
        if(session.getAttribute("current") == null){
            resp.sendRedirect("../do.invalidaccess");
            return;
        }
