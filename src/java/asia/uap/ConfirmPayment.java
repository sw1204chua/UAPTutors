 ...
 * @author Hawy
 */
@WebServlet(name = "ConfirmPayment", urlPatterns = {"/profile/do.confirmpayment"})
public class ConfirmPayment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String successmsg = "Thank you for your payment! Please wait for the tutor to confirm";
        String err = "Could Not Be Paid!";
        String href1 = "";
        String href1msg = "";
        String booked_id = request.getParameter("booked_id");
        String reference = request.getParameter("reference");
        Boolean error = false;
        if (booked_id == null || booked_id.isEmpty() || reference == null || reference.isEmpty()){
            error = true;
        }
        ...
        if (!error){
            ...
            try{
                dbOp.setListingPaid(listing, reference);
