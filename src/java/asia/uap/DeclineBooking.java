 ...
 * @author Hawy
 */
@WebServlet(name = "DeclineBooking", urlPatterns = {"/profile/do.declinebooking"})
public class DeclineBooking extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String successmsg = "Booking has been Declined! Listing is now available";
        String err = "Booking Could Not Be Declined!";
        String href1 = "";
        String href1msg = "";
        ...
        if(!error){
            try{
                dbOp.deleteStudentListing(listing);
