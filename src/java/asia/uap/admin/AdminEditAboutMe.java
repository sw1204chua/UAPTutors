 ...
 * @author Hawy
 */
@WebServlet(name = "AdminEditAboutMe", urlPatterns = {"/admin/do.editaboutme"})
public class AdminEditAboutMe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Boolean error = false;
        if(aboutme==null||aboutme.isEmpty() || user_id == null || user_id.isEmpty()){
            error = true;
        }
        ...
        log("about me and int: "+aboutme+user_id_int);
        if(!error){
            try{               
                dbOp.updateUserAbout(aboutme, user_id_int);
            }catch(SQLException ex){
                ex.printStackTrace();
                error = true;
            }           
        ...
        String successmsg = "Your About section has been updated!";
