 ...
 * @author Hawy
 */
@WebServlet(name = "AdminAwardsList", urlPatterns = {"/admin/do.awardslist"})
public class AdminAwardsList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String href1 = "";
        String href1msg = "";
        request.setAttribute("biolist", userAwards);       
        if (!error) {
