 ...
 * @author Hawy
 */
@WebServlet(name = "AdminSaveSkillEdits", urlPatterns = {"/admin/do.saveskilledits"})
public class AdminSaveSkillEdits extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String oldskill = request.getParameter("old_item");
        String skill = request.getParameter("item");
        Boolean error = false;
        if (user == null || oldskill == null || oldskill.isEmpty() || skill == null || skill.isEmpty()){
            error = true;
        }
        if (!error){
            try{
                dbOp.deleteUserSkills(oldskill, user.getId());
                dbOp.addUserSkills(user.getId(), skill);
        ...
        String successmsg = "Your Skill has been updated!";
