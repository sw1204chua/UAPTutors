 ...
 * @author Hawy
 */
@WebServlet(name = "AdminEditSkills", urlPatterns = {"/admin/do.editskill"})
public class AdminEditSkills extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("item", skill);       
        href1 = "do.skillslist?user="+user.getId();
