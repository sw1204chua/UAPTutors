 ...
 * @author Hawy
 */
@WebServlet(name = "AdminDeleteLanguage", urlPatterns = {"/admin/do.deletelanguage"})
public class AdminDeleteLanguage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Boolean error = false;
        if (language == null || language.isEmpty() || user == null){
            error = true;
        }
        if (!error){
            try{
                dbOp.deleteUserLanguages(language, user.getId());
        ...
        String successmsg = "Language Successfully Deleted!";
