 ...
 * @author Hawy
 */
@WebServlet(name = "AdminDeleteAward", urlPatterns = {"/admin/do.deleteaward"})
public class AdminDeleteAward extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Boolean error = false;
        if (award == null || award.isEmpty() || user == null){
            error = true;
        }
        if (!error){
            try{
                dbOp.deleteUserAwards(award, user.getId());
        ...
        String successmsg = "Award Successfully Deleted!";
