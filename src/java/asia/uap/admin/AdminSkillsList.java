 ...
 * @author Hawy
 */
@WebServlet(name = "AdminSkillsList", urlPatterns = {"/admin/do.skillslist"})
public class AdminSkillsList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        User user = new User();
        user = (User) session.getAttribute("editing");
        ...
        String href1 = "";
        String href1msg = "";
        request.setAttribute("biolist", userskills);
        if (!error) {
