 ...
 * @author Hawy
 */
@WebServlet(name = "AdminEditAward", urlPatterns = {"/admin/do.editaward"})
public class AdminEditAward extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("item", award);       
        href1 = "do.awardslist?user="+user.getId();
        href1msg = "Back to Awards List";
